...
#line 1 "/Users/chipmc/Documents/Maker/Particle/Projects/RTC-Watchdog/src/RTC-Watchdog.ino"
/*
...
void loop();
void timeCheckRTC();
void syncRTCtoParticleTime();
void publishRTCTime();
void secondsTillAlarm();
void minuteRepeatingAlarm();
void hourlyRepeatingAlarm();
void pinInterruptHandler();
int setTimeZone(String command);
int setAlarmSeconds(String command);
int setAlarmMode(String command);
bool meterParticlePublish(void);
#line 23 "/Users/chipmc/Documents/Maker/Particle/Projects/RTC-Watchdog/src/RTC-Watchdog.ino"
